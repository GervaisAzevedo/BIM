...
CGAL::Graphics_scene PointSetVisualizer::createEmptyScene() {
    return CGAL::Graphics_scene();
}

void PointSetVisualizer::addPointSetToSceneFromData(CGAL::Graphics_scene& scene, const GeomData& data, ColoringMode mode) {

    auto pointSet = Conversions::pclToCgal(*data.rawPoints);
    switch (mode) {
...
void PointSetVisualizer::addPointSetToSceneFromData(CGAL::Graphics_scene& scene, const GeomData& data, int r, int g, int b) {
    auto pointSet = Conversions::pclToCgal(*data.rawPoints);
